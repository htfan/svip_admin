    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				"price": {
                    // Number, floating decimal. credit: orefalo
				...
				"time": {
                    ...
                    "alertText": "* 无效的时间，格式必需为 09:59:00"
                },
				"datetime":{
					"regex": /^(\d{1,4})(-|\/)(\d{1,2})\2(\d{1,2}) (\d{1,2}):(\d{1,2}):(\d{1,2})$/,
                    "alertText": "* 无效的日期，格式必需为 YYYY-MM-DD hh:ii:ss"
				},
                "ipv4": {
				...
				"ajaxUserCallPhp": {
                    "url": "/admin/staff/public_checkname_ajax",
                    // you may want to pass extra data on the ajax call
