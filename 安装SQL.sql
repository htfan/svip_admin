...
VALUES
	(2,'admin','helloWorld','index','',60,38),
	(2,'admin','manage','go_15','',59,15),
	(2,'admin','manage','logout','',58,8),
	(2,'admin','profile','change_pwd','',57,7),
	(2,'admin','manage','index','',56,6),
	(2,'admin','manage','go_5','',55,5),
	(2,'admin','manage','go_4','',54,4),
	(2,'admin','manage','go_1','',53,1);
...
VALUES
	(1,'首页',0,1,1,'manage','admin','go_1','0',1,0,1,1,'home','0','1,5,40,41,6,7,8',1,1),
	(2,'用户管理',0,2,1,'manage','admin','go_2','0',1,0,1,1,'street-view','0','2,9,31,32,33,34,35,36,37,10,26,27,28,29,30',1,1),
	(3,'栏目管理',0,3,1,'manage','admin','go_3','0',1,0,1,1,'list-ol','0','3,11,16,17,18,19,20,12,13,14,21,22,23,24,25,39',1,1),
	(4,'扩展模块',0,4,1,'manage','admin','go_4','0',1,0,1,1,'dropbox','0','4,15,38',1,1),
	(5,'我的',1,5,1,'manage','admin','go_5','0',1,0,1,1,'','0,1','5,40,41,6,7,8',1,1),
	(6,'控制面板',5,6,1,'manage','admin','index','0',1,0,1,1,'','0,1,5','6',0,1),
	(7,'修改密码',5,7,1,'profile','admin','change_pwd','0',1,0,1,1,'','0,1,5','7',0,1),
	(8,'注销',5,8,1,'manage','admin','logout','0',1,0,1,1,'','0,1,5','8',0,1),
	(16,'栏目列表',11,16,1,'moduleMenu','admin','index','0',1,0,1,1,'','0,3,11','16,17,18,19,20',1,1),
	(9,'管理用户',2,9,1,'manage','admin','go_9','0',1,0,1,1,'','0,2','9,31,32,33,34,35,36,37',1,1),
	(10,'管理用户组',2,10,1,'manage','admin','go_10','0',1,0,1,1,'','0,2','10,26,27,28,29,30',1,1),
	(11,'管理栏目',3,11,1,'manage','admin','go_11','0',1,0,1,1,'','0,3','11,16,17,18,19,20',1,1),
	(12,'管理模块',3,12,1,'manage','admin','go_12','0',1,0,1,1,'','0,3','12,13,14,21,22,23,24,25,39',1,1),
	(13,'已安装模块列表',12,13,1,'moduleManage','admin','index','0',1,0,1,1,'','0,3,12','13',0,1),
	(14,'安装新模块',12,14,1,'moduleInstall','admin','index','0',1,0,1,1,'','0,3,12','14,21,22,23,24,25,39',1,1),
	(15,'模块列表',4,15,1,'manage','admin','go_15','0',1,0,1,1,'','0,4','15,38',1,1),
	(17,'新增',16,17,1,'moduleMenu','admin','add','0',1,0,1,1,'','0,3,11,16','17',0,1),
	(18,'修改',16,18,1,'moduleMenu','admin','edit','0',1,0,1,1,'','0,3,11,16','18',0,1),
	(19,'删除',16,19,1,'moduleMenu','admin','delete','0',1,0,1,1,'','0,3,11,16','19',0,1),
	(20,'设置左侧菜单',16,20,1,'moduleMenu','admin','set_menu','0',1,0,1,1,'','0,3,11,16','20',0,1),
	(21,'安装',14,21,1,'moduleInstall','admin','setup','0',1,0,1,1,'','0,3,12,14','21',0,1),
	(22,'检查',14,22,1,'moduleInstall','admin','check','0',1,0,1,1,'','0,3,12,14','22',0,1),
	(23,'重装',14,23,1,'moduleInstall','admin','reinstall','0',1,0,1,1,'','0,3,12,14','23',0,1),
	(24,'卸载',14,24,1,'moduleInstall','admin','uninstall','0',1,0,1,1,'','0,3,12,14','24',0,1),
	(38,'Hello Word',15,38,1,'helloWorld','admin','index','0',1,0,1,1,'','0,4,15','38',0,1),
	(25,'删除',14,25,1,'moduleInstall','admin','delete','0',1,0,1,1,'','0,3,12,14','25',0,1),
	(26,'用户组列表',10,26,1,'role','admin','index','0',1,0,1,1,'','0,2,10','26,27,28,29,30',1,1),
	(27,'新增',26,27,1,'role','admin','add','0',1,0,1,1,'','0,2,10,26','27',0,1),
	(28,'编辑',26,28,1,'role','admin','edit','0',1,0,1,1,'','0,2,10,26','28',0,1),
	(29,'删除',26,29,1,'role','admin','delete_one','0',1,0,1,1,'','0,2,10,26','29',0,1),
	(30,'设置权限',26,30,1,'role','admin','setting','0',1,0,1,1,'','0,2,10,26','30',0,1),
	(31,'用户列表',9,31,1,'user','admin','index','0',1,0,1,1,'','0,2,9','31,32,33,34,35,36,37',1,1),
	(32,'新增',31,32,1,'user','admin','add','0',1,0,1,1,'','0,2,9,31','32',0,1),
	(33,'编辑',31,33,1,'user','admin','edit','0',1,0,1,1,'','0,2,9,31','33',0,1),
	(34,'检测用户名',31,34,1,'user','admin','check_username','0',1,0,1,1,'','0,2,9,31','34',0,1),
	(35,'删除',31,35,1,'user','admin','delete','0',1,0,1,1,'','0,2,9,31','35',0,1),
	(36,'锁定/解锁',31,36,1,'user','admin','lock','0',1,0,1,1,'','0,2,9,31','36',0,1),
	(37,'上传头像',31,37,1,'user','admin','upload','0',1,0,1,1,'','0,2,9,31','37',0,1),
	(39,'上传安装包',14,39,1,'moduleInstall','admin','index','0',1,0,1,1,'','0,3,12,14','39',0,1),
	(41,'全局缓存',5,7,1,'manage','admin','cache','0',1,0,1,1,'','0,1,5','41',0,1);
